    ...
    <View style={styles.Container}>
      ...
      <View style={styles.ContainerBody}>
        ...
        <View style={styles.ContainerPayment}>
          ...
          <TextDefault
            value={stateTransfer.idTransactionLocal.recipient_name}
          />
          <View style={styles.ContainerTextDescription}>
          ...
          <TextDefault
            value={stateTransfer.idTransactionLocal.recipient_norek}
          />
          <View style={styles.ContainerTextDescription}>
          ...
          <View style={{flexDirection: 'row', alignSelf: 'center'}}>
            <TextDefault
              value={stateTransfer.idTransactionLocal.virtual_account}
            />
            <TouchableOpacity
